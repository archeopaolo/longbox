...
## Aggiornamento
La cache PWA è `longbox-shell-v16`.
...
## Catalogo digitale (v16)
- Aggiunta manuale di una singola scheda digitale.
- Modifica delle schede digitali già catalogate.
- Generazione in blocco di intervalli di numeri digitali, con Legacy facoltativo e progressivo.
- I file CBZ/CBR/PDF non vengono copiati né caricati su Drive.
